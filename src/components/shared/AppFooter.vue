			...
			socials: [
				{
					...
					name: 'GitHub',
					icon: 'github',
					url: 'https://github.com/olivernha',
				},
				{
					id: 2,
					name: 'Twitter',
					icon: 'twitter',
					url: 'https://twitter.com/oliver_nha',
				},
				{
					id: 3,
					name: 'Facebook',
					icon: 'facebook',
					url: 'https://www.facebook.com/profile.php?id=100009412815085',
				},
				{
					id: 4,
					name: 'Instagram',
					icon: 'instagram',
					url: 'https://www.instagram.com/oliver_nha/',
				},
			],
		};
	},
